...
const Header = () =>{
    return <header className="d-flex justify-content-center py-3 color">
      <ul className="nav nav-pills">
        <li className="nav-item"><Link to="/" className="nav-link color-active text-white" aria-current="page"><i data-feather="home"></i> Inicio</Link></li>
